...
Ver detalles en [Desarrollando características bajo el enfoque TDD en _Ruby on Rails_][1].
...
* [_A Guide to Testing Rails Applications_][5] **(Guía oficial de _Rails_/_Official Rails guide_)**
